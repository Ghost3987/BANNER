...
echo "";
echo -e "
\033[0;31m┌─[\033[1;34m$TNAME\033[1;33m-\033[1;36mKING\033[0;31m]─[\033[0;32m~${PWD/#"$HOME"}\033[0;31m]
...
PROMPT=$'
%{\e[0;31m%}┌─[%{\e[1;34m%}%B%{\${TNAME}%}%{\e[1;33m%}-%{\e[1;36m%}KING%b%{\e[0;31m%}]─[%{\e[0;32m%}%(4~|/%2~|%~)%{\e[0;31m%}]%b
...
1. CHANCE YOUR TERMUX THEME
2. Syntax-Highlight (\e[33mplugins\e[01;32m)
3. ghost-command-autosuggest (\e[33mplugins\e[01;32m)
4. Terminal-Header
...
if [ -d $HOME/.oh-my-zsh ]; then
	...
	echo -e "\e[1;34m[*] \e[32mYou hvnt Ghost...\e[0m";
fi
while [ $ozsh = 0 ];
do
	echo -e "\e[1;34m[*] \e[32mGhost new setup....\e[0m";
	echo "";
...
echo -e "\e[1;34m[*] \e[32mGhost-autosuggestion plugins setup..\e[0m";
...
while [ $zshsyx = 0 ];
do
echo -e "\e[1;34m[*] \e[32mGhost-syntax-highlighter setup....\e[0m";
